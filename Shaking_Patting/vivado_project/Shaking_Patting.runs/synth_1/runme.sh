...
HD_PWD='C:/Users/14817/Desktop/WorkStation_Entry/DatenLord/cy_mit_6.175/Shaking_Patting/vivado_project/Shaking_Patting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handshake_pipe_ready_patting.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handshake_pipe_ready_patting.tcl
